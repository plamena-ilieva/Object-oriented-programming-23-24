...
bool Triangle::isIntersectedWith(Shape* shape)
{
	return shape->isIntersectedWithTriangle(this);
}

bool Triangle::isIntersectedWithRectange(Rectangle* shape)
{
	std::cout << "Triangle + Rectangle" << std::endl;
	return true;
}

bool Triangle::isIntersectedWithTriangle(Triangle* shape)
{
	std::cout << "Triangle + Triangle" << std::endl;
	return true;
}

bool Triangle::isIntersectedWithCircle(Circle* shape)
{
